...
export class MainComponent {
  ...
  initialRoute:string = this.storageService.getToken() ? 'client' : 'landing'
  constructor(private _bottomSheet: MatBottomSheet, private _dialog:MatDialog, private storageService:StorageService, private router: Router, private route:ActivatedRoute) {}
